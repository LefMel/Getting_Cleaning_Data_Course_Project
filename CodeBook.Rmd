...
final_data - a 180 x 89 table - containing the average of each variable from the sum_data table for each activity (LabelName) and each subject (Subject_ID)
The final_data is saved as a .txt file (final_data.txt) in the working directoty and uploaded in the GitHub repository.
